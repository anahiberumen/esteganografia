...
def ocultar_texto(mensaje, imagen, ruta_imagen_salida):
	...
	nombre_imagen = os.path.splitext(ruta_imagen_salida)[0]
	if not os.path.exists('/tmp/imagenes'):
		os.makedirs('/tmp/imagenes')
	ruta_imagen = '/tmp/imagenes/{}.png'.format(nombre_imagen)
